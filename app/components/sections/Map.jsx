  ...
  return (
    <div className="max-w-7xl mx-auto px-6 mt-24 space-y-12">
      <div className="text-center">
        {/* UPDATED: COVERED to Red */}
        <h2 className="text-4xl font-black text-gray-900 tracking-tighter uppercase italic">
          AREAS <span className="text-[#b50926]">COVERED</span>
        </h2>
        {/* UPDATED: Line to Blue */}
        <div className="w-20 h-1.5 bg-[#0009c5] mx-auto mt-4 rounded-full"></div>
      </div>
      ...
      >
        {/* UPDATED: Blue tint overlay */}
        <div className="absolute inset-0 bg-[#0009c5]/5 pointer-events-none group-hover:bg-transparent transition-colors z-10" />
