...
const TestimonialsBottom = () => {
  return (
    <div className="mt-12 md:mt-24 bg-gray-900 rounded-[2rem] md:rounded-[3.5rem] p-8 md:p-12 relative overflow-hidden mx-4 md:mx-0">
      {/* 1. BACKGROUND GLOW */}
      <div className="absolute top-0 right-0 w-48 h-48 md:w-64 md:h-64 bg-[#0009c5] blur-[80px] md:blur-[120px] opacity-20"></div>
      ...
      <div className="relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-y-10 gap-x-4 md:gap-8 text-center">
        {[
          ...
          <div key={i} className="flex flex-col items-center">
            <h3 className="text-[#0009c5] text-3xl md:text-4xl font-black italic mb-1 uppercase tracking-tighter">
              {stat.val}
            </h3>
