      ...
      <div className="bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-gray-100 grid grid-cols-1 lg:grid-cols-2">
        <div className="p-8 md:p-12 space-y-8">
          <div>
            ...
            <h2 className="text-3xl font-black text-[#0009c5] italic tracking-tighter uppercase">
              Book Your Lesson
            </h2>
          ...
          <form className="space-y-4">
            ...
            <div className="relative group">
              <MessageSquare
                className="absolute left-4 top-5 text-gray-400 group-focus-within:text-[#0009c5] transition-colors"
                size={18}
              />
              <textarea
                rows={3}
                placeholder="Driving experience or any questions?"
                className="w-full pl-12 pr-4 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:border-[#0009c5] focus:bg-white outline-none transition-all font-bold text-gray-700 text-sm shadow-inner"
              ></textarea>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-[#0009c5] text-white py-5 rounded-2xl font-black text-lg flex items-center justify-center gap-3 group shadow-xl shadow-blue-100"
            >
              Send Request{" "}
              <Send
        ...
        <div className="relative min-h-[500px] bg-gray-900 group overflow-hidden">
          ...
          <div className="absolute top-8 right-8 bg-[#b50926] text-white p-4 rounded-full shadow-2xl animate-pulse">
            <Car size={32} strokeWidth={2.5} />
          </div>

          <div className="absolute bottom-12 left-12 text-white z-10">
            <div className="flex items-center gap-3 mb-3">
              <div className="bg-[#b50926] p-2 rounded-xl shadow-lg shadow-red-500/20">
