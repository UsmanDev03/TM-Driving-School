    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {testimonialsData.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm hover:shadow-3xl hover:shadow-orange-200/40 transition-all duration-500"
            >
              {/* Floating Quote */}
