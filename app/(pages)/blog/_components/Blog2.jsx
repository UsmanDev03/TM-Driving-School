...
export default function Blog2() {
  ...
  const faqs = [
    {
      q: "Will my test route change?",
      a: "Examiners know about the roadworks. They pick roads that are clear but still test your skill.",
    },
    {
      q: "Is it better to learn at night?",
      a: "We offer evening lessons when the roads are a bit more quiet.",
    },
    {
      q: "How long do the works last?",
      a: "The main work ends in April, but weekend closures last until July 2026.",
    },
  ];
          ...
          <div className="max-w-3xl mx-auto space-y-12 px-4">
            <section className="space-y-8 pt-10">
              <p className="text-lg leading-relaxed text-gray-600 font-medium">
                If you drive in Notting Hill or Shepherd's Bush, you have seen
                the cones. The A40 Westway is closed for big repairs. This
                changes how we do our driving lessons.
              </p>
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  The Westway is shut between the roundabout and Marylebone
                  Flyover until late April 2026. After that, it will close on
                  weekends until July. This makes local roads very busy.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Harrow Road and Ladbroke Grove have more cars and buses than
                  ever. This is a tough time for learners, but it is a good way
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    We try to avoid the worst traffic to give you more time
                    behind the wheel. We use the back roads to teach you how to
                    steer and brake safely.
                  </p>
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    More people are using bikes and scooters to avoid the car
                    jams. You must check your mirrors twice before you turn. We
                    show you how to spot these hazards early.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  We use the traffic as a classroom. In our Mercedes A-Class, we
                  show you how to keep the car steady in slow queues. We also
                  teach you how to stay calm when the roads are loud and busy.
                </p>
              </div>
            </section>
            ...
            <section className="space-y-6 pt-4">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                The Westway works make driving in West London harder than usual.
                But learning in these conditions makes you a better driver. We
                know these roads better than anyone. We can show you how to
                drive safely even when the traffic is at its worst. Join us to
                start your lessons in Notting Hill today.
              </p>
            </section>
          </div>
        </article>
