    ...
    html: `
      <div style="${mainStyle}">
        ...
        <div style="${contentStyle}">
          ...
          <a href="tel:${mobile_number}" style="display: inline-block; background: #000; color: #fff; padding: 12px 25px; text-decoration: none; border-radius: 4px; font-weight: bold; margin-top: 10px;">CALL NOW</a>
        </div>
